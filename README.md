...
`baton-wiz-insights` is a connector for built using the [Baton SDK](https://github.com/conductorone/baton-sdk).

Check out [Baton](https://github.com/conductorone/baton) to learn more the project in general.

# Prerequisites
No prerequisites were specified for `baton-wiz-insights`
...
```
docker run --rm -v $(pwd):/out -e BATON_DOMAIN_URL=domain_url -e BATON_API_KEY=apiKey -e BATON_USERNAME=username ghcr.io/conductorone/baton-wiz-insights:latest -f "/out/sync.c1z"
...
`baton-wiz-insights` will pull down information about the following resources:
- Users

`baton-wiz-insights` does not specify supporting account provisioning or entitlement provisioning.
