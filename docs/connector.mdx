...
{/* AUTO-GENERATED:END - config-params */}
  ...
  <Tab title="Self-hosted">
    ...
    * [Official download center](https://dist.conductorone.com/ConductorOne/baton-wiz-insights): For stable binaries (Windows/Linux/macOS) and container images.

    * [GitHub repository](https://github.com/conductorone/baton-wiz-insights): Access the source code, report issues, or contribute to the project.
